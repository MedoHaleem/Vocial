...
_chat2.default.loadChat(_socket2.default);
});
...
var getStatus = function getStatus(metas) {
    return metas.length > 0 && metas[0]["status"];
};

// Sync up the list of users to the current Presence State
var syncUserList = function syncUserList(presences) {
    (0, _jquery2.default)(".username-list").empty();
    _phoenix.Presence.list(presences, function (username, _ref) {
        var metas = _ref.metas;

        var status = getStatus(metas);
        (0, _jquery2.default)(".username-list").append("<li class=\"" + status + "\">" + username + "</li>");
    });
};

var resetTimer = function resetTimer(channel, username) {
    var skipPush = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;

    if (!skipPush) {
        channel.push("user_active", { username: username });
    }
    clearTimeout(idleTimeout);
    idleTimeout = setTimeout(function () {
        channel.push("user_idle", { username: username });
    }, TIMEOUT);
};

var addStatusMessage = function addStatusMessage(username, status) {
    (0, _jquery2.default)(".chat-messages").append("<li class=\"status\">" + username + " is " + status + "...</li>");
};

var handlePresenceDiff = function handlePresenceDiff(diff) {
    ...
    Object.keys(joins).forEach(function (username) {
        var metas = joins[username]["metas"];
        var status = getStatus(metas);
        addStatusMessage(username, status);
    });
    // Finally, display messages for each person that leaves the chat too!
    Object.keys(leaves).forEach(function (username) {
...
var handlePresenceState = function handlePresenceState(state) {
    presences = _phoenix.Presence.syncState(presences, state);
    syncUserList(presences);
};

// Provide a way to hide the current chat UI
var hideChatUI = function hideChatUI() {
    (0, _jquery2.default)("div.chat-ui").addClass("hidden");
};

// And a way to show the chat UI
var showChatUI = function showChatUI() {
    (0, _jquery2.default)("div.chat-ui").removeClass("hidden");
};

// Utility functions
// Add a message to the list of chat messages
var addMessage = function addMessage(author, message) {
    var chatLog = (0, _jquery2.default)(".chat-messages").append("<li>\n        <span class=\"author\">&lt;" + author + "&gt;</span>\n        <span class=\"message\">" + message + "</span>\n      </li>");
};
...
var onJoin = function onJoin(res, channel) {
    (0, _jquery2.default)(".chat-send").on("click", function (event) {
        event.preventDefault();
        var message = (0, _jquery2.default)(".chat-input").val();
        var author = (0, _jquery2.default)(".author-input").val();
...
var loadChat = function loadChat(socket) {
    ...
    (0, _jquery2.default)(".join-chat").on("click", function () {
        var username = (0, _jquery2.default)(".author-input").val();
...
var connect = function connect(socket, username) {
    ...
    var channel = socket.channel("chat:" + chatroom, { username: username });
    ...
    channel.on("new_message", function (_ref2) {
...
exports.default = { loadChat: loadChat };
});
